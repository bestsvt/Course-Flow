          ...
          <div>
            <Menu>
              ...
              <MenuList>
                ...
                <MenuItem icon={<HiOutlineClipboardCheck className="text-blue-300 text-lg" />} onClick={() => { navigate("/myassignments")}}>
                  <p className="text-gray-700 font-headline1">My Assignments</p>
                </MenuItem>
